...
const Attributes = () => {
    return (
        ...
        <div className="relative flex flex-col pt-4 md:pt-28 md:pl-16 mx-auto w-1/2 md:w-3/5 bg-primary text-text_dark">
        ...
        <div className='absolute left-0 bottom-0 w-4 h-2/5 bg-icon'></div>
          <div className='flex md:flex-row flex-col items-center justfity-start mb-2'>
            ...
            <h2 className='text-text_dark text-2xl sm:text-3xl md:text-5xl mt-1 font-lovelo'>CARACTERÍSTICAS<br></br> FÍSICAS</h2>
          </div>
          <div className='md:grid grid-cols-2 gap-y-8  ml-20 mt-7 w-3/5'>
