...
const Attributes = () => {
    return (
        ...
        <div className="sm:w-1/2 md:w-2/5 xs:w-full xs:h-2/3">
          <Image src={charsImg} quality={100} className='h-screen'/>
        </div>
        <div className="relative flex flex-col pt-4 md:pt-28 md:pl-16 bg-primary text-text_dark mx-auto xs:w-full sm:w-1/2 md:w-3/5 xs:h-1/3 sm:h-full">
        ...
        <div className='absolute left-0 bottom-0 w-4 h-2/5 bg-icon'></div>
          ...
          <div className='grid grid-cols-2 sm:flex sm:flex-col xs:mx-auto sm:ml-20 mt-7'>
